...
inherit cmake llvm-r1 xdg pax-utils

if [[ ${PV} == *9999 ]]; then
	inherit git-r3
	EGIT_REPO_URI="https://github.com/dolphin-emu/dolphin"
	EGIT_SUBMODULES=( Externals/{mGBA/mgba,implot/implot,tinygltf/tinygltf,Vulkan-Headers,VulkanMemoryAllocator,zlib-ng/zlib-ng,minizip-ng/minizip-ng} )
else
...
src_prepare() {
	if [[ ${PV} != *9999 ]]; then
		...
		use mgba && mv -T "${WORKDIR}/mgba-${MGBA_COMMIT}" Externals/mGBA/mgba || die
	fi
