...
nexusmods.paths.testinghelpers@0.8.0
nexusmods.paths@0.1.8
nexusmods.paths@0.4.0
nexusmods.paths@0.8.0
nexusmods.paths@0.9.0
nexusmods.paths@0.9.2
...
perfolizer@0.2.1
projektanker.icons.avalonia.materialdesign@9.1.2
projektanker.icons.avalonia@9.1.2
...
SMAPI_COMMIT="e8a86a0b98061d322c2af89af845ed9f5fd15468"
...
DOTNET_PKG_TEST_EXTRA_ARGS=( --filter "RequiresNetworking!=True&FlakeyTest!=True" )

src_prepare() {
	mv -T ${WORKDIR}/SMAPI-${SMAPI_COMMIT} ${S}/extern/SMAPI || die

	# Requires networking
	sed -i -e '/Test_LoadAndCache_\(RemoteImage\|ImageStoredFile\)/i    [Trait("RequiresNetworking", "True")]' tests/NexusMods.UI.Tests/ImageCacheTests.cs || die
