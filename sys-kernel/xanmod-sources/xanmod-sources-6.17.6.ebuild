...
src_unpack() {
	...
	# disable_sse4a Doesn't apply cleanly due to xanmod changes
	UNIPATCH_LIST_DEFAULT="${DISTDIR}/patch-${OKV}-xanmod${XANMOD_VERSION}.xz
		${FILESDIR}/xanmod-6.17.6_disable_sse4a.patch"
	UNIPATCH_EXCLUDE="${UNIPATCH_EXCLUDE} 1*_linux-${KV_MAJOR}.${KV_MINOR}.*.patch 1710_disable_sse4a.patch"
